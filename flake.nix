{
  ...
  outputs = {
    ...
    flake-utils.lib.eachDefaultSystem (system: let
      ...
      embeddings = craneLib.buildPackage (individualCrateArgs
        // {
          pname = "embeddings";
          cargoExtraArgs = "-p embeddings";
          src = fileSetForCrate ./embeddings;
        });
      focus = craneLib.buildPackage (individualCrateArgs
        // {
          pname = "focus";
          cargoExtraArgs = "-p focus";
          src = fileSetForCrate ./focus;
        });
      gardener = craneLib.buildPackage (individualCrateArgs
        // {
          pname = "gardener";
          cargoExtraArgs = "-p gardener";
          src = fileSetForCrate ./gardener;
        });
      llm-assistant = craneLib.buildPackage (individualCrateArgs
        // {
          pname = "llm-assistant";
          cargoExtraArgs = "-p llm-assistant";
          src = fileSetForCrate ./llm-assistant;
        });
      llm-toolkit = craneLib.buildPackage (individualCrateArgs
        // {
          pname = "llm-toolkit";
          cargoExtraArgs = "-p llm-toolkit";
          src = fileSetForCrate ./llm-toolkit;
        });
      speedtest-to-influx = craneLib.buildPackage (individualCrateArgs
        // {
    ...
    in {
      ...
      # Executed by `nix run .`
      apps = {
        embeddings = flake-utils.lib.mkApp {
          drv = embeddings;
        };
        llm-assistant = flake-utils.lib.mkApp {
          drv = llm-assistant;
        };
      };
